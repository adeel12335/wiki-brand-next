...
export const pricingTiers = [
  ...
  },
  {
    ...
    features: {
      ...
      wikidata: true,
      disclosure: true,
      revisions: "Until accepted or blocker documented",
      talkPage: true,
      monitoring: "90 days",
      language: false,
      report: "Written notability report",
  ...
  },
  {
    ...
    features: {
      ...
      revisions: "Until accepted or blocker documented",
      talkPage: true,
      monitoring: "6 months + quarterly report",
      language: "1 included",
...
export const pricingFaqs = [
  ...
  },
  {
    ...
    a: "No. Reviewer-feedback revisions are included in your tier. On Standard and above we keep responding to reviewer comments until the article is accepted or a genuine blocker is documented in writing.",
  },
  {
...
export const comparisonRows: Array<{
  ...
  },
  {
    ...
    values: [
      pricingTiers[0].features.monitoring,
